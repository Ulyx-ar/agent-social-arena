...
const OwnershipModel = makeEnum({
    SINGLE: "single",
    TOKEN: "token",
});
const RoyaltyModel = makeEnum({
    CREATORS: "creators",
    FANOUT: "fanout",
    SINGLE: "single",
});
const Scope = makeEnum({
    FULL: "full",
    ROYALTY: "royalty",
    METADATA: "metadata",
    EXTENSION: "extension",
});
const UseMethods = makeEnum({
    BURN: "Burn",
    SINGLE: "Single",
    MULTIPLE: "Multiple",
});
const Context = makeEnum({
...
const AssetSortBy = makeEnum({
    ID: "id",
    CREATED: "created",
    UPDATED: "updated",
    RECENT_ACTION: "recent_action",
});
const AssetSortDirection = makeEnum({ ASC: "asc", DESC: "desc" });
const TokenStandard = makeEnum({
...
const UiTransactionEncoding = makeEnum({
    Binary: "binary",
    Base64: "base64",
    Base58: "base58",
    Json: "json",
...
exports.AssetSortBy = AssetSortBy;
exports.AssetSortDirection = AssetSortDirection;
exports.Context = Context;
exports.Interface = Interface;
exports.OwnershipModel = OwnershipModel;
exports.PriorityLevel = PriorityLevel;
exports.RoyaltyModel = RoyaltyModel;
exports.Scope = Scope;
exports.TokenStandard = TokenStandard;
exports.UiTransactionEncoding = UiTransactionEncoding;
