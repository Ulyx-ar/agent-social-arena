...
export type GetProgramAccountsV2Response = GetProgramAccountsV2Result | RpcResponse<GetProgramAccountsV2Result>;
export type GtaV2DataSlice = {
    length: number;
    offset: number;
};
...
export type GetTokenAccountsByOwnerV2Response = GetTokenAccountsByOwnerV2Result | RpcResponse<GetTokenAccountsByOwnerV2Result>;
...
export type GetTransactionsForAddressConfigSignatures = GetTransactionsForAddressBaseConfig & {
    transactionDetails?: "signatures";
};
export type GetTransactionsForAddressConfigFull = GetTransactionsForAddressBaseConfig & {
    transactionDetails: "full";
};
export type GetTransactionsForAddressConfig = GetTransactionsForAddressConfigSignatures | GetTransactionsForAddressConfigFull;
